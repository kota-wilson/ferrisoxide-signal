...
This crate does not define pass/fail policy, TOML configuration, report schemas, SVG rendering, DAQ acquisition, RTOS adapters, or certification evidence. `ferrisoxide-core` remains responsible for converting measurement facts into criteria results and reports.
