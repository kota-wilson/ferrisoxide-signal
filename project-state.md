...
Expected deliverable: Open the DOCS-001 PR, wait for protected CI, and merge only after required checks pass.
...
- Next gate: Complete DOCS-001 PR creation and protected CI.
